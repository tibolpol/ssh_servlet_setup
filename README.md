...
SYNOPSIS
        ssh_servlet_setup [-h] | user@host:command
...
DESCRIPTION
        ...
        Si la servlet doit lire l'entrée standard, il faudra ensuite
        éditer le client et supprimer l'option -n dans la commande ssh.
